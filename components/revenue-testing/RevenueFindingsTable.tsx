...
import type { RevenueFinding, RiskLevel } from "@/lib/revenue-testing/types";
...
export function RevenueFindingsTable({ findings }: { findings: RevenueFinding[] }) {
  ...
  return (
    <SectionCard title="Invoice Exception Register" description="Line-level revenue exceptions ranked by AI risk score.">
            ...
            <tbody className="divide-y divide-slate-100">
              {paginated.map((f) => (
                <tr key={f.id} className="hover:bg-slate-50/80">
                  ...
                  <td className="px-4 py-3 text-slate-700">{f.customerName}</td>
