...
import { WORKFLOW_STEPS } from "@/lib/revenue-testing/constants";
import type { WorkflowStepId } from "@/lib/revenue-testing/types";
...
export function WorkflowStepper({ activeStep, completedSteps }: WorkflowStepperProps) {
  ...
  return (
    <nav
      aria-label="Revenue testing workflow"
              ...
              <span
                className={cn(
                  ...
                  isComplete || isPast
                    ...
                    : isActive
                      ? "bg-white text-indigo-700 ring-indigo-600 dark:bg-slate-900"
